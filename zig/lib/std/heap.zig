...
const page_size_min_default: ?usize = switch (builtin.os.tag) {
    ...
    .appleii, .atari2600, .atari5200, .nes, .c64, .c128, .cpm65, .cx16, .dodo, .eater, .fds,
    .geos_cbm, .atari8, .lynx, .mega65, .osi_c1p, .pce, .pce_cd, .pet, .rp6502, .rpc8e,
    .sim, .snes, .supervision, .vic20 => switch (builtin.cpu.arch) {
        .mos => 1 << 8,
        else => null,
    },
    else => null,
