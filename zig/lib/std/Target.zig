    ...
    pub const Model = struct {
        ...
        pub fn baseline(arch: Arch, os: Os) *const Model {
            return switch (arch) {
                ...
                .mos => switch (os.tag) {
                    .nes, .fds => &mos.cpu.mos6502,
                    .cx16, .lynx, .eater, .rp6502 => &mos.cpu.mosw65c02,
                    .pce, .pce_cd => &mos.cpu.moshuc6280,
                    .mega65 => &mos.cpu.mos45gs02,
                    .snes => &mos.cpu.mosw65816,
                    .atari2600 => &mos.cpu.mos6502x,
                    .rpc8e => &mos.cpu.mos65el02,
                    .supervision => &mos.cpu.mos65c02,
